...
paths:
  ...
  /{resourceUri}/providers/Microsoft.Advisor/recommendations/{recommendationId}/suppressions/{name}:
    ...
    put:
      ...
      x-api-path-slug: resourceuriprovidersmicrosoftadvisorrecommendationsrecommendationidsuppressionsname-put
      parameters:
      - in: path
        name: name
        description: The name of the suppression
    ...
    delete:
      ...
      x-api-path-slug: resourceuriprovidersmicrosoftadvisorrecommendationsrecommendationidsuppressionsname-delete
      parameters:
      - in: path
        name: name
        description: The name of the suppression
  ...
  /{resourceUri}/providers/Microsoft.Advisor/recommendations/{recommendationId}:
    get:
      ...
      x-api-path-slug: resourceuriprovidersmicrosoftadvisorrecommendationsrecommendationid-get
      parameters:
      - in: query
        name: No Name
      - in: path
  ...
  /subscriptions/{subscriptionId}/providers/Microsoft.Advisor/suppressions:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidprovidersmicrosoftadvisorsuppressions-get
      parameters:
      - in: query
        name: $skipToken
        description: The page-continuation token to use with a paged version of this
